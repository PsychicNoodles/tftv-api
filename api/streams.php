...
foreach($page -> children as $child)
{
    ...
    $item["Title"] = trim(str_replace("Title", "", str_replace("»", "", $child -> find("div[style=padding: 6px; padding-left: 0; padding-right: 18px;]", 0) -> plaintext)));
    $item["Desc"] = trim(str_replace("Description", "", str_replace("»", "", $child -> find("div[style=padding: 6px; padding-left: 0; padding-right: 18px;]", 1) -> plaintext)));
